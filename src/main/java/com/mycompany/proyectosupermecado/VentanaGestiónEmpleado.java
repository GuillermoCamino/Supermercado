...
// ========== IMPORTS NUEVOS PARA LA BASE DE DATOS ==========
...
String nombre;
    ...
    public VentanaGestiónEmpleado() {
        ...
        limpiarPlaceholders(); // Nuevo: limpiar los textos de ejemplo
    }
    ...
    // ========== MÉTODO MODIFICADO: CREAR NUEVO PERFIL ==========
    private void btnCrearPerfilActionPerformed(java.awt.event.ActionEvent evt) {                                               
        try {
            // 1. Validar campos vacíos
            if (txtNumeroDNI.getText().trim().isEmpty() || 
                txtNombreApellido.getText().trim().isEmpty() || 
            ...
            try {
                id = Integer.parseInt(txtIDEmpleado.getText().trim());
            ...
            // 3. Validar formato DNI (8 números + 1 letra)
            ...
            // 4. Crear instancia del DAO
            EmpleadoDAO empleadoDAO = new EmpleadoDAOImpl();
            
            // 5. Verificar que no exista el DNI
            ...
            // 6. Verificar que no exista el ID
            ...
            // 7. Crear el objeto Empleado
            Empleado nuevoEmpleado = new Empleado(dni, nombre, id, true);
            
            // 8. INSERTAR EN LA BASE DE DATOS
            boolean insertado = empleadoDAO.insertar(nuevoEmpleado);
            
            // 9. Mostrar resultado
            if (insertado) {
                JOptionPane.showMessageDialog(this, 
                    "Empleado registrado correctamente en la base de datos", 
                    "Perfil Guardado", 
                ...
                JOptionPane.showMessageDialog(this, 
                    "Error al registrar el empleado en la base de datos", 
                    "Error", 
                    JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void btnSalirSinGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    // ========== MÉTODO MODIFICADO: GUARDAR CAMBIOS (MODIFICAR EMPLEADO) ==========
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try {
            ...
            if (empleadoExistente == null) {
                JOptionPane.showMessageDialog(this, 
                    "No existe empleado con ese DNI. Use 'Crear Nuevo Perfil' para añadir uno nuevo.", 
                    "No encontrado", 
                    JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Si cambió el ID, verificar que no exista
            if (empleadoExistente.getId() != id && empleadoDAO.existeId(id)) {
                JOptionPane.showMessageDialog(this, 
                    "Ya existe un empleado con ese ID", 
                    "ID duplicado", 
                    JOptionPane.ERROR_MESSAGE);
            ...
            // Actualizar
            Empleado empleadoActualizado = new Empleado(dni, nombre, id, true);
            boolean actualizado = empleadoDAO.actualizar(empleadoActualizado);
            
            if (actualizado) {
                JOptionPane.showMessageDialog(this, 
                    "Empleado modificado correctamente en la base de datos", 
                    "Datos Guardados", 
                    JOptionPane.INFORMATION_MESSAGE);
                limpiarCampos();
            } else {
    ...
    private void btnCambiarPasswdActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        // TODO add your handling code here:
    ...
    /**
     * Método para validar el formato del DNI (8 dígitos + 1 letra)
     */
    ...
    /**
     * Método para limpiar los textos placeholder iniciales
     */
